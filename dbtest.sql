...
CREATE OR REPLACE TABLE EVENTO (
 ...
 CREATE OR REPLACE TABLE PROFESION (
...
CREATE OR REPLACE TABLE PERSONAJE (
...
CREATE OR REPLACE TABLE F_PERSONAJE (
...
CREATE OR REPLACE TABLE F_EVENTO (
...
CREATE OR REPLACE TABLE EVENTO_PERSONAJE (
  ID_EVENTO INTEGER NOT NULL,
  ID_PERSONAJE INTEGER NOT NULL,
...
CREATE OR REPLACE TABLE EVENTO_CASA (
  ID_EVENTO INTEGER NOT NULL,
  ID_CASA INTEGER NOT NULL,
...
CREATE OR REPLACE TABLE R_RAZA_RAZA (
...
CREATE OR REPLACE TABLE R_PERSONAJE_PERSONAJE (
...
CREATE OR REPLACE TABLE R_CASA_CASA (
...
CREATE OR REPLACE TABLE TRANSACCION_BANCARIA (
  ID_CASA INTEGER NOT NULL,
...
CREATE OR REPLACE VIEW OR REPLACE view_evento_casa_personaje AS
