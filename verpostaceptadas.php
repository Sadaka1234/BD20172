      ...
      <body>
        ...
        <div class="contenido">
            ...
            <?php
                ...
                $sql = "SELECT name, semestre, estado, profesor from taller_libre where estado = 1";
        ...
        <form action="veraceptadasfiltradas.php" method="POST">
        <input type="submit" value="filtrar para 01-2017">
        </form>
