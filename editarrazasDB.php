...
<html>
 ...
 <?php
 $editarrazas = "UPDATE raza
 SET nombre_raza = '".$_POST["nuevo_nombre_raza"]."',
 caracteristicas = '".$_POST["nuevas_caracteristicas"]."'
 WHERE id_raza = ".$_POST["id_raza"];


$save = pg_query($conn,$editarrazas);
if (!$save) {
	echo "Debes detenegte!!";

}
else {
	echo "Has cambiado tu raza correctamente!.";
	}
 ?>
